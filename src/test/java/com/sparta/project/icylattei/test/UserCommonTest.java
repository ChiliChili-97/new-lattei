...
public interface UserCommonTest {
    ...
    ProfileRequest TEST_PROFILE_REQUEST_DTO = new ProfileRequest(TEST_USER_NICKNAME, TEST_USER_INFO);
    ProfileResponse TEST_PROFILE_RESPONSE_DTO = new ProfileResponse(TEST_USER_NICKNAME, TEST_USER_INFO);
    PasswordUpdateRequest TEST_PASSWORD_UPDATE_REQUEST_DTO = new PasswordUpdateRequest(TEST_NEW_PASSWORD, TEST_CHECK_PASSWORD);
